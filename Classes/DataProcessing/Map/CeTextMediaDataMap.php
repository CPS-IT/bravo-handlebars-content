...
class CeTextMediaDataMap implements DataMapInterface
{
    ...
    public const DEFAULT_FIELD_MAPS = [
        ...
        TtContent::FIELD_ASSETS . '.pictureData.@picture.sourceS' => 'pictureData.sourceTextMedia.sourceS',
        TtContent::FIELD_ASSETS . '.pictureData.@picture.sourceM' => 'pictureData.sourceTextMedia.sourceM',
        TtContent::FIELD_ASSETS . '.pictureData.@picture.sourceL' => 'pictureData.sourceTextMedia.sourceL',
        TtContent::FIELD_ASSETS . '.pictureData.@picture.sourceXl' => 'pictureData.sourceTextMedia.sourceXl',
        TtContent::FIELD_ASSETS . '.pictureData.@picture.imgData' => 'pictureData.imgData',
        TtContent::FIELD_ASSETS . '.pictureData.@figure.caption' => 'caption',
        TtContent::FIELD_ASSETS . '.pictureData.@figure.copyrightData' => 'copyrightData',
        TtContent::FIELD_ASSETS . '.pictureData.@figure.copyrightData.copyright' => 'lightboxCopyright',
